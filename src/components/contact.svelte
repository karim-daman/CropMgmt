...
<div class=" py-1" role="none">
	<a
		...
		href="#"
		class="pressable relative block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 hover:text-gray-900 hover:outline-hidden"
		role="menuitem"
		tabindex="-1"
		id="menu-item-0"
		>{$translation('settings.support')}
	</a>
</div>
...
<div
	...
	<div
		id="drawer-contact"
		class="fixed top-0 left-0 z-40 h-screen w-80 {hidden
			? '-translate-x-full'
		...
		<form class="mb-6">
			...
			<button
				type="submit"
				class="mb-2 block w-full rounded-lg bg-blue-700 px-5 py-2.5 text-sm font-medium text-white hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 focus:outline-none dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
				>Send message</button>
		</form>
		<p class="mb-2 text-sm text-gray-500 dark:text-gray-400">
			<a href="#" class="hover:underline">
				<!-- <p class="mt-2">support: karimdd2015@gmail.com</p> -->
			</a>
		</p>
