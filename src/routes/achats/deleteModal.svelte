<script lang="ts">
	...
	function deleteRow() {
		...
		toast.success('Deleted an achat.', {
			position: 'top-right'
		});
...
<button
	...
	class=" pressable mr-1 size-6 cursor-pointer rounded-sm border text-red-500 hover:text-red-700">
	<svg
		...
		<div class="relative rounded-lg bg-white shadow-sm dark:bg-gray-700">
			...
			<div class="p-4 text-center md:p-5">
				...
				<h3 class="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">
					Are you sure you want to delete achat ID: {ID}?
				</h3>
				<button
					onclick={() => {
						deleteRow();
