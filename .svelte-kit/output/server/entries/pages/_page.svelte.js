import { a7 as fallback, a0 as attr, a8 as bind_props, W as pop, T as push, a2 as stringify, a4 as ensure_array_like, a3 as store_get, Z as escape_html, a5 as unsubscribe_stores } from "../../chunks/index.js";
...
function _page($$payload, $$props) {
  ...
  $$payload.out += `<!--]--></div> <div class="mb-8 grid grid-cols-1 gap-6 lg:grid-cols-2"><div class="mt-11.5 h-[55vh] overflow-hidden rounded-lg bg-white shadow"><div class="p-5"><h2 class="mb-4 text-lg font-medium text-gray-900 select-none">Revenue Overview</h2> <div class="h-64"></div></div></div> <div><div class="mb-4 flex justify-between"><h2 class="text-lg font-medium text-gray-900 select-none"><div type="button" class="relative inline-flex items-center rounded bg-indigo-500 px-5 py-1 text-center text-sm font-medium text-white">History <div class="absolute -end-2 -top-2 inline-flex h-6 w-6 items-center justify-center rounded-full border-2 border-white bg-red-500 text-xs font-bold text-white dark:border-gray-900"><p class="text-[9px]">${escape_html(store_get($$store_subs ??= {}, "$history", history).length)}</p></div></div></h2> <div>`;
