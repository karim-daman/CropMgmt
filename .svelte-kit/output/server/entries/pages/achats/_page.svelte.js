...
function _page($$payload, $$props) {
  ...
  $$payload.out += `<div class="rounded bg-white p-6 shadow"><div class="flex justify-between"><h1 class="mb-4 text-2xl font-bold">Achats</h1> <p class="no-print text-xs">(fields that have * are mandatory)</p></div> <div class="mb-4 flex space-x-4"><!--[-->`;
